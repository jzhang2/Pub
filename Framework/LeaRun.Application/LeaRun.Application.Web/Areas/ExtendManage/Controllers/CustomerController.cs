...
namespace LeaRun.Application.Web.Areas.ExtendManage.Controllers
{
    ...
    public class CustomerController : MvcControllerBase
    {
        ...
        [HttpGet]
        public ActionResult ExistEmail(string FullName, string keyValue) {
            bool IsOk = customerbll.ExistEmail(FullName, keyValue);
            return Content(IsOk.ToString());
        }
        [HttpGet]
        public ActionResult ExistMobile(string FullName, string keyValue) {
            bool IsOk = customerbll.ExistMobile(FullName, keyValue);
            return Content(IsOk.ToString());
        }
        #endregion
